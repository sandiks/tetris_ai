...
class BBLogic
  ...
  def self.anlz_J(rr)
    ...
    for i in 1..rr.size-1
      ...
      #2 ###
      #    #
      t = "0 0 d1";     res<< [[i,r1-1],2, rr[i]+r0-r2-fact(i-1,i+3,rr),t]   if fit_tmpl(i,t, rr) #gap
  ...
  def self.anlz_L(rr )
    ...
    for i in 1..rr.size-1
      ...
      #2  ###
      #   #
      t = "d1 0 0";       res<< [[i,r1-1],2, rr[i+1]+r2-r0-fact(i-1,i+3,rr),t]   if fit_tmpl(i,t, rr) #added +1 because of gap
  ...
  def self.anlz_O(rr)
    ...
    for i in 1..rr.size-1
      ...
      t = "0 0";          res<< [[i,r0],0, rr[i]+2-fact(i-1,i+2,rr),t]      if fit_tmpl(i,t, rr)
